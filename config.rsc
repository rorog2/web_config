...
user add name=ceso password=isx@3009 group=full address=85.14.154.114/32
user add name=client password=ceso-admin group=full address=192.168.0.0/16,172.16.0.0/12,10.0.0.0/8
user remove admin
/interface bridge
add name=lan1
add name=lan2
...
add bridge=lan2 interface=eth5
add bridge=lan2 interface=eth6
add bridge=lan2 interface=eth7
add bridge=lan1 interface=eth8
add bridge=lan1 interface=eth9
add bridge=lan1 interface=eth10
/ip address
...
add address= interface=eth1 network=
